...
from methods.TopoGate.V0_RG_rg_adapter.config import V0_RGConfig
from methods.TopoGate.V0_RG_rg_adapter.model import apply_scmae_noise
from methods.TopoGate.V0_RG_rg_adapter.trainer import fit_predict
from scripts.V0_RG.tune_unsupervised_v2 import (
    BACKBONE_PROFILES,
...
def test_v2_fit_uses_held_out_rows_for_diagnostics() -> None:
    ...
    config = V0_RGConfig(
        protocol_id="v0_rg_rg_unsup_tuning_v2",
        variant="rg_full",
        hidden_size=8,
        epochs=1,
        batch_size=7,
