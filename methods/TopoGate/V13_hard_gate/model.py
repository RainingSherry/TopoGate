"""Masked autoencoder used by the V13 hard-gate variant.

V13 inherits the V12 AutoEncoder unchanged — the only difference from V12 is
the replacement of LearnableGate (softmax + rank_loss) with GumbelTopKGate
