...
# This public release replaces original local paths with portable relative
# paths. The formal result implementation digest is preserved in its report.
IMPLEMENTATION_REVISION = "r1_prelaunch_review_public_release"
...
DATASETS = (
    ...
    DatasetSpec("macosko", "Macosko", "scRNA", "datasets/Macosko.h5ad", "h5ad", None, "resolved_label"),
    DatasetSpec("melanoma", "Melanoma_5K", "scRNA", "datasets/Melanoma_5K.h5ad", "h5ad", None, "resolved_label"),
    DatasetSpec("quake", "Quake_Smart-seq2_Lung", "scRNA", "datasets/Quake_Smart-seq2_Lung.h5ad", "h5ad", None, "resolved_label"),
    DatasetSpec("wang", "Wang", "scRNA", "datasets/Wang.h5ad", "h5ad", None, "resolved_label"),
    DatasetSpec("news20", "news20", "nonbiological", "datasets/news20.npz", "npz_csr", None, "y"),
    DatasetSpec("rcv1", "rcv1_train", "nonbiological", "datasets/rcv1_train.npz", "npz_csr", None, "y"),
    DatasetSpec("arcene", "arcene", "nonbiological", "datasets/arcene.npz", "npz", "x", "y"),
