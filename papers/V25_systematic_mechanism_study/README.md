...
- Closure artifact bundle: [`results/`](results/) (weight-free Gap Map, taxonomy, E1 summary, and next-series decision)
...
The `results/` directory is generated by `scripts/V25/build_closure_artifacts.py` from frozen A0/A1/A2,
E1/E2/E3, and Phase E JSON/CSV artifacts. It contains no checkpoint, branchpoint, raw data, prediction
array, embedding, or cache. `V25_CLOSURE_ARTIFACTS.json` records source hashes and checks that the six
E1 datasets, V1--V24 taxonomy coverage, and the `inconclusive_not_completed` holdout boundary are preserved.
