...
# The public snapshot intentionally omits the local count registry because it
# contains machine-specific dataset paths. Reproduction callers can pass a
# compatible JSON registry through ``load_registry(path)`` or ``--registry``.
