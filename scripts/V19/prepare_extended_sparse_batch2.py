...
CANDIDATES: tuple[dict[str, Any], ...] = (
    {
        ...
        "name": "20newsgroups",
        "source_path": "/data/luolie/ToPoGate/datasets/20newsgroups.npz",
    ...
    },
    {
        ...
        "name": "reuters",
        "source_path": "/data/luolie/ToPoGate/datasets/reuters.npz",
        "input_protocol": "shared_text",
        "family": "highdim_text",
        "selection_basis": "fixed second-panel high-dimensional text candidate",
    },
    {
        ...
        "name": "enron",
        "source_path": "/data/luolie/ToPoGate/datasets/enron.npz",
        "input_protocol": "shared_text",
        "family": "highdim_text",
        "selection_basis": "fixed second-panel high-dimensional text candidate",
    },
    {
        ...
        "name": "wos",
        "source_path": "/data/luolie/ToPoGate/datasets/wos.npz",
        "input_protocol": "shared_text",
        "family": "highdim_text",
        "selection_basis": "fixed second-panel high-dimensional text candidate",
    },
    {
        ...
        "name": "ISOLET",
        "source_path": "/data/luolie/ToPoGate/datasets/ISOLET.npz",
    ...
    },
    {
        ...
        "name": "secom",
        "source_path": "/data/luolie/ToPoGate/datasets/secom.npz",
        "input_protocol": "clubench_bridge",
    ...
    },
    {
        ...
        "name": "webdata_wXa",
        "source_path": "/data/luolie/ToPoGate/datasets/external/v9_related_20260806/processed/webdata_wXa.npz",
        "input_protocol": "clubench_bridge",
        "family": "web_sparse",
