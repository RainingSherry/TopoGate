...
_DEFAULT_HOLDOUT_UNIVERSE_ROOTS = (
    "datasets/external/scCluBench/data/processed",
    "datasets/external/scCluBench/data/processed_scmae",
    "datasets/external/scCluBench/data/other",
    "datasets/external/test-datasets/scrnaseq/h5ad",
    "datasets/external/ScienceAgentBench/pbmc68k",
    "datasets/external/ScienceAgentBench/pbmc_umap",
    "datasets/external/scSSL-Bench/data/PBMC",
)
HOLDOUT_UNIVERSE_ROOTS = tuple(
    value for value in os.environ.get("TOPOGATE_HOLDOUT_UNIVERSE_ROOTS", "").split(os.pathsep) if value
) or _DEFAULT_HOLDOUT_UNIVERSE_ROOTS
