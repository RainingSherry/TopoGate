#!/usr/bin/env python3
"""Multi-seed verification for v9 = LearnableGate + Adaptive PCA (no HVF).

Runs v9_adaptive (LearnableGate + reliability mix + topo neighbours, no HVF,
adaptive PCA upper bound 2000) on 15 datasets × 3 seeds = 45 runs.

Outputs:
  result/v9_learnable_gate/multiseed/<dataset>__v9_adaptive__seed{N}.json
  result/v9_learnable_gate/multiseed/comparison.csv
"""
...
DATASETS = [
    # 15 datasets — aligned with v2 multiseed (learnable_gate_sched)
...
VARIANTS = {
    # v9: LearnableGate + reliability mix + topo neighbours + no HVF + Adaptive PCA(2000)
    "v9_adaptive": {
...
OUTPUT_DIR = Path("/home/luolie/ToPoGate/result/v9_learnable_gate/multiseed")
